...
We've collected a large dataset of vaccine coverage data (see `measles_vax-coverage-data.qmd`). In order to use use this data to inform the ABM, we have to take care of a few modelling and formatting tasks (in this rough order):
