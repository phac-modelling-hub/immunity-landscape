...
vax_clean1 %>% #bind_rows(vax_CA) %>%  # attach adult estimates from aNICS?
  readr::write_csv(here::here("data", "measles_vax-coverage-data-clean1.csv"))
```
...
vax_clean2 %>% #bind_rows(vax_CA) %>%  # attach adult estimates from aNICS?
  readr::write_csv(here::here("data", "measles_vax-coverage-data-clean2.csv"))
```
