...
From a quick by-eye model selection, current best GP model parameter values are approximately `l1=1.5, l2=3, b=0.75` for `k=ksqexp`.
...
GPcombinations_GDP <- select_GP(vax_clean, prov_values=prov_values, k_list=list(ksqexp=ksqexp), l1=c(0.5,1,1.5,2,2.5), l2=c(0.5,1,2,3,4), b=c(0.5,1,1.5,2))
...
GPcombinations_GDP_cNICS <- select_GP(vax_cNICS, prov_values=prov_values, k_list=list(ksqexp=ksqexp, kexp=kexp), l1=c(0.5,1,1.5,2,2.5), l2=c(0.5,1,2,3,4), b=c(0.5,1,1.5,2))
...
Relation of provinces is encoded in `prov_values` and can be extracted from the function `extract_province_relation()`. This function has a number of socioecomonic datasets preloaded in a standardised format for use in the GP model.
...
GPcombinations_lowincome<- select_GP(vax_clean, prov_values="low_income_families", k_list=list(ksqexp=ksqexp, kexp=kexp), l1=c(0.5,1,1.5,2,2.5), l2=c(0.5,1,2,3,4), b=c(0.5,1,1.5,2))
...
run_GP(vax_clean, prov_values="low_income_families", l1=1.5, l2=3, b=0.75)
#ggsave(paste0("plots/bestmodel",l1,"_l2",l2,"_ksqexp","_lowincome",".pdf"), height=4.51, width=7.29)
run_GP(vax_cNICS, prov_values="low_income_families", l1=1.5, l2=3, b=0.75)
#ggsave(paste0("plots/cNICSmodel",l1,"_l2",l2,"_ksqexp","_lowincome",".pdf"), height=4.51, width=7.29)
```
