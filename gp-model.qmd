...
run_GP <- function(vax_dataset, first_agecurrent=1, last_agecurrent=32, yvals=NA, k=NA, k_name=NA, l1=NA, l2=NA, ndrws=50, b=1) {
  ...
  yvals <- yvals*l2  # scale y values to the x lengthscale
  if (is.na(b)) b <- 1  # optional extra parameter for covariance
